...
<table>
  ...
  <tr>
    <td>API</td>
    <td>https://www.mars-cloud.com/api/login</td>
  </tr>
  <tr>
    <td>Method</td>
    <td>HTTP Post</td>
  ...
  <tr>
    <td>Body</td>
    <td>{"usr": "&lt;your-account&gt;", "pwd": "&lt;your-password&gt;", "proj": "&lt;your-project&gt;" }</td>
  </tr>
</table>
...
![認證使用](https://www.mars-cloud.com/images/1706754765790.jpg)
...
<table>
  ...
  <tr>
    <td>API</td>
    <td>https://www.mars-cloud.com/api/put?data</td>
  </tr>
  <tr>
    <td>Method</td>
    <td>HTTP Post</td>
...
<table>
  ...
  <tr>
    <td>API</td>
    <td>https://www.mars-cloud.com/api/get?data</td>
  </tr>
  <tr>
    <td>Method</td>
    <td>HTTP Post</td>
...
<table>
  ...
  <tr>
    <td>API</td>
    <td>https://www.mars-cloud.com/api/lastdata?method=read</td>
  </tr>
  <tr>
    <td>Method</td>
    <td>HTTP Post</td>
...
<table>
  ...
  <tr>
    <td>API</td>
    <td>https://www.mars-cloud.com/api/getbyday</td>
  </tr>
  <tr>
    <td>Method</td>
    <td>HTTP Post</td>
...
<table>
  ...
  <tr>
    <td>API</td>
    <td>https://www.mars-cloud.com/api/del?data</td>
  </tr>
  <tr>
    <td>Method</td>
    <td>HTTP Post</td>
...
<table>
  ...
  <tr>
    <td>API</td>
    <td>https://www.mars-cloud.com/api/usrinfo?method=datasrcinfo</td>
  </tr>
  <tr>
    <td>Method</td>
    <td>HTTP Post</td>
...
<table>
  ...
  <tr>
    <td>API</td>
    <td>https://www.mars-cloud.com/api/usrinfo?method=updatedatasrc</td>
  </tr>
  <tr>
    <td>Method</td>
    <td>HTTP Post</td>
...
<table>
  ...
  <tr>
    <td>API</td>
    <td>https://www.mars-cloud.com/services/service.YourServiceName/YourServiceAPI</td>
  </tr>
  <tr>
    <td>Method</td>
    <td>HTTP Get/Post</td>
...
```text
https://www.mars-cloud.com/services/service.mytest/api/hello
```
